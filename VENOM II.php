	...
	<div class="container movie-detail">
		<div class="row">
			...
			<div class="col-md-6 text-center">
				<img src="image-movie/m-25.png" class="movie-img">
				<div class="overlay">
					<a href="https://www.youtube.com/watch?v=-ezfi6FQ8Ds" class="icon" title="Play">
		...
		<div class="container series">
			...
			<div class="popular-movies">
				<img src="image-movie/ve5.png">
				<img src="image-movie/ve3.png">
				<img src="image-movie/ve2.png">
				<img src="image-movie/ve4.jpg">
...
<style>
	body
{
	background-image: linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)), url(image-movie/background18.png);
